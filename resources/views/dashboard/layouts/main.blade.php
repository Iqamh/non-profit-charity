          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              <li class="nav-item">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link {{ Request::is('events', 'events/create', 'events/edit/*') ? 'active' : '' }}" href="{{ Route('events') }}">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link {{ Request::is('causes', 'causes/create', 'causes/edit/*') ? 'active' : '' }}" href="{{ Route('causes') }}">
            ...
            <nav class="navbar d-flex justify-content-end navbar-light flex-md-nowrap p-0">
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3 py-3" data-toggle="dropdown" href="#" 
                ...
                <!-- ============================================= nav admin Site ============================================= -->
                  <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="{{ url('dashboard/dashboardUsers') }}/{{ Auth::user()->name }}/edit"><i class="icon-feather-edit"></i> Edit Profile</a>
